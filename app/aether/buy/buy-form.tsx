    ...
    <div className="flex flex-col gap-6">
      ...
      {!isCustom && (
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-center text-[rgb(var(--muted))]" style={{ opacity: 0.35, gap: 4 }}>
            <span className="text-[12px] tracking-tight" style={{ lineHeight: 1 }}>Powered and secured by</span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 468 222.5" fill="currentColor" style={{ height: 14, width: "auto", display: "block" }} aria-label="Stripe" role="img">
