    ...
    <div className="flex flex-col gap-6">
      ...
      {!isCustom && (
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-baseline justify-center text-[rgb(var(--muted))]" style={{ opacity: 0.35, gap: 6 }}>
            <span className="text-[12px] tracking-tight">Powered and secured by</span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="54 36 360 122" fill="currentColor" style={{ height: 16, width: "auto" }} aria-label="Stripe" role="img">
